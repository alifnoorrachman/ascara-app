...
class PublicController extends Controller
{
    public function index()
    {
        ...
        $retails = Retail::latest()->take(6)->get();
        $works = Work::with(['service'])->latest(6)->take(6)->get();
        $articles = Article::latest(4)->take(5)->get();
        
        return view('public.home', compact('services', 'works', 'articles','retails'));
    }
    ...
    {
        $services = Service::all();
        $retails = Retail::latest()->paginate(8);
        return view('public.retails', compact('retails','services'));
    }
