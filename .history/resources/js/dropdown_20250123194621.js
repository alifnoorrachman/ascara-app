document.addEventListener('DOMContentLoaded', function() {
    ...
    function setTheme(theme) {
        ...
        if (theme === 'Le Menegement') {
            ...
            if (logoElement) logoElement.src = 'path/to/menegement-logo.png';
        } else if (theme === 'teMilan') {
            [navbar, footer, body].forEach(element => {
                element.classList.add('theme-milan');
            });
            // Ganti logo untuk teMilan
            if (logoElement) logoElement.src = 'path/to/temilan-logo.png';
        } else {
            // Logo default (Ascara)
            if (logoElement) logoElement.src = 'path/to/ascara-logo.png';
        }
