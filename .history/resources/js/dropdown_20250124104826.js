document.addEventListener('DOMContentLoaded', function() {
    ...
    function setTheme(theme) {
        ...
        if (theme === 'Le Menegement') {
            ...
            logoElement.classList.remove('h-12');
            });
...
dropdownButton.addEventListener('click', function () {
    ...
    dropdownBackdrop.classList.toggle('hidden'); // Tampilkan/semmbunyikan backdrop
...
dropdownBackdrop.addEventListener('click', function () {
    ...
    dropdownBackdrop.classList.add('hidden'); // Sembunyikan backdrop
