<div class="container py-10 w-full max-w-3xl px-4 sm:px-6 lg:px-8 bg-colorNetral rounded-xl">
    <div class="text-center mb-10 text-colorThree">
    ...
    <div class="space-y-4 py-4">
        ...
        <div class="accordion-item bg-white shadow">
            <h2 class="accordion-header">
                <button 
                    class="accordion-button text-left w-full py-4 px-5 rounded-lg bg-blue-100 font-medium hover:bg-colorThree hover:text-colorNetral flex justify-between items-center"
