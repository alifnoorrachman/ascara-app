    ...
    <div class="space-y-4 py-4">
        ...
        <div class="accordion-item bg-white shadow">
            <h2 class="accordion-header">
                <button 
                    class="accordion-button text-left w-full py-4 px-5 rounded-lg text-colorOne bg-blue-100 font-medium hover:bg-colorOne hover:text-colorNetral flex justify-between items-center"
