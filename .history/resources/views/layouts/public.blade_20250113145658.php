        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-12 mb-12">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
                ...
                <div data-animate>
                    ...
                    <ul class="space-y-2">
                        <li><a href="#" class="text-colorTwo hover:text-colorNetral transition">Our Work</a></li>
                        <li><a href="#" class="text-colorTwo hover:text-colorNetral transition">About</a></li>
                        <li><a href="#" class="text-colorTwo hover:text-colorNetral transition">Contact</a></li>
                    </ul>
                </div>
                <div data-animate>
