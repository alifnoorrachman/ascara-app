            ...
            <div data-animate>
                ...
                <form class="flex gap-4 max-w-md">
                    <input
                        ...
                        class="flex-1 px-4 py-2 border-2 border-colorNetral focus:outline-none focus:ring-2 focus:ring-colorThree bg-colorNetral text-colorNetral rounded-lg"
                    />
                    <button
                        type="submit"
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-0">
                ...
                <div data-animate>
                    ...
                    <ul class="space-y-2">
                        ...
                        <li><a href="#" class="text-colorTwo hover:text-colorNetral transition">{{ $servicefooter->title }}</a></li>
                        @endforeach
                    </ul>
                </div>
                <div data-animate class="pl-14">
