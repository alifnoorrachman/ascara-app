        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-12 mb-12">
            ...
            <div data-animate>
                ...
                <form class="flex gap-4 max-w-md">
                    ...
                    <button
                        type="submit"
                        class="px-6 py-2 text-colorNetral border-colorNetral border-2 font-semibold rounded-lg hover:bg-colorThree hover:text-colorThree transition duration-300"
                    >
                        Subscribe
                    </button>
                </form>
