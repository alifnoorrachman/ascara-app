    ...
    <nav class="fixed w-full mx-2 rounded-lg px-6 bg-colorOne text-colorNetral shadow-sm transition-transform duration-300" id="navbar">
        <div class="mx-4 sm:mx-6 lg:mx-8 px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16 items-center">
                ...
                <div class="flex-shrink-0 flex items-center" x-data="{ 
                    showThemeMenu: false,
                    ...
                    <div class="theme-dropdown ml-2">
                        ...
                        <div class="theme-menu" :class="{ 'show': showThemeMenu }">
                            ...
                            <div class="theme-section management">
                                <h3 class="font-semibold text-red-700 mb-2">Management</h3>
                                <div class="space-y-2">
                                    <div class="theme-option" @click="currentTheme = 'default'; applyTheme('default')">
                                        Default Theme
                                    </div>
                                    <div class="theme-option" @click="currentTheme = 'dark'; applyTheme('dark')">
                                        Dark Theme
                                    </div>
                                    <div class="theme-option" @click="currentTheme = 'elegant'; applyTheme('elegant')">
                                        Elegant Theme
                                    </div>
                                </div>
                            </div>
                
                            <!-- Appearance Section (Blue) -->
                            <div class="theme-section appearance">
                                <h3 class="font-semibold text-blue-700 mb-2">Appearance</h3>
                                <div class="space-y-3">
                                    <div class="theme-option">
                                        <label class="block text-sm mb-1">Text Color</label>
                                        <input type="color" 
                                               :value="themes[currentTheme].textColor"
                                               @input="updateTheme('textColor', $event.target.value)"
                                               class="w-full h-8 rounded cursor-pointer">
                                    </div>
                                    <div class="theme-option">
                                        <label class="block text-sm mb-1">Background Color</label>
                                        <input type="color" 
                                               :value="themes[currentTheme].bgColor"
                                               @input="updateTheme('bgColor', $event.target.value)"
                                               class="w-full h-8 rounded cursor-pointer">
                                    </div>
                                    <div class="theme-option">
                                        <label class="block text-sm mb-1">Font Style</label>
                                        <select @change="updateTheme('fontFamily', $event.target.value)"
