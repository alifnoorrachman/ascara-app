        ...
        <div class="mx-4 sm:mx-6 lg:mx-8 px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16 items-center">
                ...
                <div class="theme-dropdown relative">
                    <button id="themeButton" onclick="toggleThemeDropdown()" class="flex items-center text-sm border border-colorNetral px-3 py-1 mt-2 gap-2 hover:bg-colorOne hover:text-white transition-colors rounded-lg">
                        Change Theme
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
