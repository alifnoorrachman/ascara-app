        ...
        <div class="mx-4 sm:mx-6 lg:mx-8 px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16 items-center">
                ...
                <div class="flex-shrink-0 flex items-center">
                    ...
                    <!-- Tombol ganti tema dengan panah -->
                    <button id="themeButton" onclick="toggleThemeDropdown()" class="ml-3 flex items-center text-sm gap-2 hover:bg-colorOne hover:text-white transition-colors rounded-lg">
                        <span>Change Theme</span>
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                        </svg>
                    </button>
                    <!-- Dropdown untuk Change Theme -->
                    <div id="themeDropdown" class="dropdown-content absolute bg-white text-black rounded-lg shadow-lg hidden mt-2 w-40 z-50">
                        <div id="currentTheme" class="px-4 py-2">Currently Active: Theme A</div>
                        <a href="javascript:void(0)" onclick="changeTheme('blue', 'Arial, sans-serif', 'A')" class="block px-4 py-2 hover:bg-gray-200">Theme A</a>
                        <a href="javascript:void(0)" onclick="changeTheme('green', 'Courier New, monospace', 'B')" class="block px-4 py-2 hover:bg-gray-200">Theme B</a>
                        <a href="javascript:void(0)" onclick="changeTheme('red', 'Times New Roman, serif', 'C')" class="block px-4 py-2 hover:bg-gray-200">Theme C</a>
                    </div>
                </div>
