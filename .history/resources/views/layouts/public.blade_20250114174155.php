...
<body class="text-colorNetral bg-colorOne">
    ...
    <nav>
        <!-- Theme Switcher -->
        <form action="{{ route('theme.switch') }}" method="POST" class="theme-switcher">
            @csrf
            <select name="theme" onchange="this.form.submit()">
                <option value="ascara" {{ $theme['name'] == 'Ascara Theme' ? 'selected' : '' }}>Ascara</option>
                <option value="le-management" {{ $theme['name'] == 'Le Management Theme' ? 'selected' : '' }}>Le Management</option>
                <option value="temilan" {{ $theme['name'] == 'Temilan Theme' ? 'selected' : '' }}>Temilan</option>
            </select>
        </form>
    </nav>
