...
<body class="text-colorNetral bg-colorOne">
    ...
    <nav class="fixed w-full mx-2 rounded-lg px-6 py-6 bg-colorOne text-colorNetral shadow-sm transition-transform duration-300" id="navbar">
        <div class="mx-4 sm:mx-6 lg:mx-8 px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16 items-center">
                <!-- Logo and Dropdown -->
                <div class="flex-shrink-0 flex items-center">
                    ...
                    <div class="relative">
                        ...
                        <!-- Dropdown Menu -->
                        <div id="dropdownMenu" class="absolute hidden mt-2 w-48 bg-white rounded-lg shadow-lg py-2 z-50">
                            <a href="#" class="block px-4 py-2 text-sm text-gray-700 hover:bg-colorOne/50">Ascara</a>
                            <a href="#" class="block px-4 py-2 text-sm text-gray-700 hover:bg-colorOne/50">Le Menegement</a>
                            <a href="#" class="block px-4 py-2 text-sm text-gray-700 hover:bg-colorOne/50">teMilan</a>
                        </div>
                    </div>
                </div>
