...
<body class=" mt-2">
    ...
    <nav class="fixed w-full mx-2 rounded-lg px-6 shadow-sm transition-transform duration-300" id="navbar">
                ...
                <div class="flex-shrink-0 flex items-center">
                    <div class="relative">
                        ...
                        <div id="dropdownMenu" class="absolute hidden mt-2 w-48 bg-white rounded-lg shadow-lg py-2 z-50">
                            <a href="#" class="block px-4 py-2 text-sm text-colorOne hover:bg-colorOne/50">Ascara</a>
                            <a href="#" class="block px-4 py-2 text-sm text-colorOne hover:bg-colorOne/50">Le Menegement</a>
                            <a href="#" class="block px-4 py-2 text-sm text-colorOne hover:bg-colorOne/50">teMilan</a>
                        </div>
                    </div>
                </div>
