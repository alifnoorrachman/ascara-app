        ...
        <div class="mx-4 sm:mx-6 lg:mx-8 px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16 items-center">
                ...
                <div class="hidden sm:flex">
                    <a href="#"
                       class="text-sm border px-3 py-1 mt-2 inline-flex items-center gap-2 transition-colors rounded-lg">
                        Let's Talk
...
<footer class=" mt-auto">
    <div class="mx-2 sm:mx-8 md:mx-16 lg:mx-20 px-6 pt-12 pb-1">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-12 mb-12">
            ...
            <div data-animate>
                ...
                <form class="flex gap-4 max-w-md">
                    ...
                    <button
                        type="submit"
                        class="px-6 py-2 border-2 font-semibold rounded-lg transition duration-300"
                    >
                        Subscribe
                    </button>
                </form>
        ...
        <!-- Footer Bottom -->
        <div class="py-4 text-sm rounded-xl mb-2">
            <div class="flex flex-col md:flex-row justify-between items-center">
                <div class="mx-2 md:mb-0">
                    <ul class="flex space-x-6">
                        <li><a href="{{route('faqs')}}" class="">FAQ's</a></li>
