            ...
            <div class="flex justify-between h-16 items-center">
                ...
                <div class="flex-shrink-0 flex items-center">
                    <div class="relative flex items-center logo-container">
                        <img src="../images/LogoAscara.png" alt="Logo" class="h-10 w-10 object-cover logo-image" id="themeLogo">
                        ...
                        <!-- Dropdown Menu -->
                        <div id="dropdownMenu" class="absolute hidden mt-2 w-48 bg-white text-colorOne rounded-lg shadow-lg py-2 z-50">
