            ...
            <div class="flex justify-between h-16 items-center">
                ...
                <div class="flex-shrink-0 flex items-center">
                    <div class="relative flex items-center logo-container">
                        ...
                        <!-- Dropdown Menu -->
                        <div id="dropdownMenu" class="absolute hidden mt-2 w-48 bg-white text-colorOne rounded-lg shadow-lg py-2 z-80 y-80">
                            <a href="#" class="block px-4 py-2 text-sm">ascara</a>
                            <a href="#" class="block px-4 py-2 text-sm">Lè Management</a>
