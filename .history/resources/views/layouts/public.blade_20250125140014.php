...
<head>
    ...
    @viteReactRefresh
    @vite(['resources/css/app.css','resources/css/card.css','resources/css/theme.css','resources/css/parallax.css','resources/js/app.js','resources/js/dropdown.js','resources/js/navbar.js','resources/js/app.jsx'])
            ...
            <div class="flex justify-between h-16 items-center">
                ...
                <div class="flex-shrink-0 flex items-center">
                    <div class="relative flex items-center logo-container">
                        ...
                        <!-- Dropdown Button -->
                        <button id="dropdownButton" class="ml-2 text-xl font-semibold flex items-center gap-1 relative">
                            ascara
                        ...
                        <!-- Dropdown Menu -->
                        <div id="dropdownMenu" class="absolute hidden mt-2 w-48 bg-white text-gray-800 rounded-lg shadow-lg py-2 z-50">
                            <a href="#" class="block px-4 py-2 text-sm hover:bg-gray-100">ascara</a>
                            <a href="#" class="block px-4 py-2 text-sm hover:bg-gray-100">Lè Management</a>
                            <a href="#" class="block px-4 py-2 text-sm hover:bg-gray-100">temilan</a>
                        </div>
                    </div>
                </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-12 mb-12">
            ...
            <div data-animate>
                ...
                <form class="flex gap-4 max-w-md">
                    ...
                    <button
                        type="submit"
                        class="button px-6 py-2 border-2 border-b-slate-700 font-semibold rounded-lg transition duration-300"
                    >
                        Subscribe
                    </button>
                </form>
