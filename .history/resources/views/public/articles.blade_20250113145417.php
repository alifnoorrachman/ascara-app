...
<section class="container mx-auto px-4 py-12 text-colorNetral">
    <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div data-animate class="col-span-1 md:col-span-3 text-colorNetral">
            <h2 class="text-2xl font-medium mb-6">More Articles</h2>
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 bg-colorNetral">
                @foreach($articles as $article)
                    <div class="rounded-lg overflow-hidden transition-all duration-300 hover:shadow-xl group">
                        <div class="relative">
                            @if($article->image)
