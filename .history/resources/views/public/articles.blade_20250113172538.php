...
{{-- Main Content --}}
{{-- Main Content --}}
<section class="container mx-auto px-4 py-12 text-colorNetral">
    <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div data-animate class="col-span-1 md:col-span-2">
            ...
            @endphp
            <div class="group text-white rounded-2xl overflow-hidden shadow-md transition-all duration-300 hover:shadow-xl">
                <div class="relative">
        ...
        {{-- First Side Article --}}
        <div data-animate class="col-span-1 hidden md:block group text-colorOne">
            <h2 class="text-2xl font-medium mb-6 text-colorNetral">Recent Article</h2>
            <div class="rounded-lg overflow-hidden transition-all duration-300 hover:shadow-xl bg-colorNetral shadow-md">
                ...
                <div class="p-6">
                    ...
                    <p class="mt-2 line-clamp-3 text-colorTwo">
                        {{ Str::limit(strip_tags($firstSideArticle->content), 100) }}
                    </p>
                    <a href="{{ route('articles.show', $firstSideArticle->id) }}" 
                       class="mt-4 text-colorTwo hover:underline flex items-center">
                        Read More
        ...
        <div data-animate class="col-span-1 md:col-span-3 text-colorOne">
            <h2 class="text-2xl font-medium mb-6 text-colorNetral">More Articles</h2>
