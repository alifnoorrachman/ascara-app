...
<article class="max-w-6xl mx-auto px-4 py-8 text-colorNetral">
    ...
    <div class="mb-8 text-colorNetral">
        <h1 class="text-3xl font-bold mb-4 text-center leading-tight text-colorNetral">
            {{ $article->title }}
        </h1>
    </div>

    {{-- Article Content --}}
    <div data-animate class="prose prose-lg max-w-none mb-8 text-colorNetral prose-h1:text-colorNetral">
        {!! $article->content !!}
    </div>
</article>
