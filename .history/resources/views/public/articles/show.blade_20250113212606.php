...
<div class="container mx-auto px-2 my-4 sm:px-6 lg:px-8">
    ...
    {{-- Related Articles --}}
    <div class="w-full max-w-6xl mx-auto px-4 sm:px-6 py-6 sm:py-8 md:py-10 text-colorNetral">
        <h3 data-animate class="text-lg sm:text-xl md:text-2xl font-medium mb-4 sm:mb-6 md:mb-8">
            Related Articles
        </h3>
        ...
        <div data-animate>
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
                @foreach(App\Models\Article::where('id', '!=', $article->id)->latest()->take(3)->get() as $relatedArticle)
                    <div class="group bg-colorNetral rounded-lg shadow-md hover:shadow-xl transition-all duration-300">
                        <x-article-card 
