    ...
    <div data-animate class="flex flex-col md:flex-row gap-12 items-start">
        ...
        <div class="w-full md:w-1/3 flex flex-col">
            <div class="flex items-center mb-6">
                <div class="w-4 h-4 bg-colorOne mr-4"></div>
                <h2 class="text-lg font-medium">Who We Are</h2>
            </div>
            <!-- Image Container -->
            <div class="rounded-lg overflow-hidden w-full h-[300px] sm:h-[400px] md:h-[500px]">
                <img src="/images/hero.jpg" alt="Studio professional" class="w-full h-full object-cover">
            </div>
        </div>
        ...
        <div class="w-full md:w-2/3 flex flex-col">
            ...
            <!-- Description -->
            <p class="text-base sm:text-lg text-colorTwo mb-8">
...
<section class="px-6 md:px-20 py-16">
        ...
        <div class="flex flex-col md:flex-row"> 
            <div data-animate class="md:w-full mb-8 md:mb-0"> 
                ...
                <div class="h-px bg-colorOne w-full mt-1"></div> 
            </div>
        </div>
        ...
        <div class="flex flex-col md:flex-row">
            ...
            <div class="md:w-1/2 mt-6 md:mt-0 pt-4">
                <div class="grid grid-cols-1 gap-4"> 
                    ...
                    <a href="#" class="group flex items-center w-full hover:bg-colorThree hover:text-colorNetral transition duration-300 py-4 px-4 rounded-lg"> 
                        <div data-animate>
                            <h3 class="text-lg font-medium">{{ $service->title }}</h3> 
                        </div>
                        <div class="ml-auto">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 group-hover:stroke-white transition duration-300">
    ...
    <section class="px-6 md:px-20 py-16">
            ...
            <div class="columns-1 sm:columns-2 lg:columns-3 gap-6 py-16 space-y-6">
                @forelse($works as $work)
                    <div class="break-inside-avoid mb-6 overflow-hidden">
                        <!-- Image Container -->
                        <div data-animate class="group relative {{ $loop->iteration % 3 == 1 ? 'h-[650px]' : ($loop->iteration % 3 == 2 ? 'h-[500px]' : 'h-[300px]') }} bg-olive-800 overflow-hidden rounded-lg">
                            <img 
                        ...
                        <div class="p-2">
                            ...
                            <div class="h-px bg-colorOne my-2"></div>
                            <div class="flex justify-between text-sm text-colorTwo">
                ...
                @empty
                    <div class="text-center py-8">
                        <p class="text-colorTwo">No works found.</p>
                    </div>
                @endforelse
            </div>
            ...
            <div class="text-right mt-4">
                <a href="{{ route('works') }}" class="inline-flex text-colorTwo items-center text-sm hover:text-colorOne transition-colors duration-300">
                    See more
  ...
  <section class="px-6 md:px-20 py-8">
    <div data-animate class="md:w-full mb-4 md:mb-0"> 
        <div class="flex items-center">
            <div class="w-4 h-4 bg-colorOne mr-4"></div> 
            <h2 class="text-lg font-medium">Business Retail</h2> 
        </div>
        <div class="h-px bg-colorOne w-full mt-1"></div> 
    </div>
    ...
    <div data-animate class="md:w-1/2 mt-4">
        ...
        <a href="{{ route('retails') }}" 
            class="border border-colorOne px-6 py-2 mt-4 inline-flex items-center gap-2 hover:bg-colorThree hover:text-colorNetral transition-colors rounded-lg">
            View all
    ...
    <div data-animate class="mx-auto px-4 py-6">
        <div class="py-4 px-2 mx-auto sm:py-4 lg:px-6">
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
                @foreach ($retails as $retail)
                <div class="aspect-square bg-gray-50"> 
                    <a href="" class="block overflow-hidden h-full w-full border shadow-md border-colorOne rounded-lg relative group">
                        <!-- Image Layer -->
                        <img 
                            src="{{ asset('storage/' . $retail->logo) }}" 
                            alt="{{ $retail->title }}" 
                            class="h-full w-full object-cover transition-all duration-300 group-hover:blur-sm"
                        >
                        <div class="absolute bottom-0 left-0 w-full flex justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                            <p class="text-colorNetral text-lg font-semibold bg-colorNetral/50 px-4 py-2 w-full text-center">
                                {{ $retail->title }}
                            </p>
                        </div>
                    </a>
  ...
  {{-- <Article> --}}
    ...
    <section class="mpx-6 md:px-20 py-4">
        <div data-animate class="md:w-full mb-8 md:mb-0"> 
            ...
            <div class="h-px bg-colorThree w-full mt-1"></div> 
        </div>
        ...
        <div data-animate class="md:w-1/2 mt-4">
            ...
            <a href="{{ route('articles') }}" 
                class="border border-colorOne px-6 py-2 mt-4 inline-flex items-center gap-2 hover:bg-colorOne hover:text-colorNetral transition-colors rounded-lg">
                View all Blog
                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                </svg>
...
{{-- contact card --}}
<section class="mx-2 mt-20 mb-40 px-4 py-20 rounded-xl bg-colorThree">
    <div data-animate class="md:w-full mb-8 md:mb-0">
        <x-contact-card 
