    ...
    <div data-animate class="flex flex-col md:flex-row gap-12 items-start">
        ...
        <div class="w-full md:w-1/3 flex flex-col">
            <div class="flex items-center mb-6">
                <div class="w-4 h-4 bg-colorNetral mr-4"></div>
...
<section class="px-6 md:px-20 py-16">
        ...
        <div class="flex flex-col md:flex-row"> 
            <div data-animate class="md:w-full mb-8 md:mb-0"> 
                ...
                <div class="h-px bg-colorNetral w-full mt-1"></div> 
            </div>
        </div>
        ...
        <div class="flex flex-col md:flex-row">
            ...
            <div class="md:w-1/2 mt-6 md:mt-0 pt-4">
                <div class="grid grid-cols-1 gap-4"> 
                    ...
                    <a href="#" class="group flex items-center w-full hover:bg-colorNetral hover:text-colorOne transition duration-300 py-4 px-4 rounded-lg"> 
                        <div data-animate>
    ...
    <section class="mpx-6 md:px-20 py-4">
        ...
        <div data-animate class="md:w-1/2 mt-4">
            ...
            <a href="{{ route('articles') }}" 
                class="border border-colorNetral px-6 py-2 mt-4 inline-flex items-center gap-2 hover:bg-colorNetral hover:text-colorOne transition-colors rounded-lg">
                View all Blog
...
{{-- contact card --}}
<section class="mx-2 mt-20 mb-40 px-4 py-20 rounded-xl bg-Netral">
    <div data-animate class="md:w-full mb-8 md:mb-0">
        <x-contact-card 
