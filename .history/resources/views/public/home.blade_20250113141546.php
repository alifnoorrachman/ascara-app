...
<section class="px-6 md:px-20 py-16">
    ...
    <section class="px-6 md:px-20 py-16">
                ...
                @forelse($works as $work)
                    <div class="break-inside-avoid mb-6 overflow-hidden">
                        ...
                        <div class="p-2">
                            ...
                            <div class="h-px bg-colorNetral my-2"></div>
            ...
            <div class="text-right mt-4">
                <a href="{{ route('works') }}" class="inline-flex text-colorTwo items-center text-sm hover:text-colorNetral transition-colors duration-300">
                    See more
