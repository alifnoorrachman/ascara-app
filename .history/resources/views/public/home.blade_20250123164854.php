        ...
        <div class="flex flex-col md:flex-row">
            ...
            <div class="md:w-1/2 mt-6 md:mt-0 pt-4">
                <div class="grid grid-cols-1 gap-4"> 
                    ...
                    <a href="{{ route('services.show', $service->id) }}" class="group flex items-center w-full hover:bg-colorNetral hover:text-colorOne transition duration-300 py-4 px-4 rounded-lg"> 
                        <div data-animate>
