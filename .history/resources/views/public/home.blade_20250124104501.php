    ...
    <div data-animate class="flex flex-col md:flex-row gap-12 items-start">
        ...
        <div class="w-full md:w-1/3 flex flex-col">
            <div class="flex items-center mb-6">
                <div class="w-4 h-4 mr-4 bg-slate-500"></div>
        ...
        <div class="flex flex-col md:flex-row">
            ...
            <div class="md:w-1/2 mt-6 md:mt-0 pt-4">
                <div class="grid grid-cols-1 gap-4"> 
                    ...
                    <a href="{{ route('services.show', $service->id) }}" class="hover-service group flex items-center w-full transition duration-300 py-4 px-4 rounded-lg"> 
                        <div data-animate>
            ...
            <div class="columns-1 sm:columns-2 lg:columns-3 gap-6 py-16 space-y-6">
                @forelse($works as $work)
                    <div data-animate class="break-inside-avoid mb-6 overflow-hidden">
                        <!-- Image Container -->
                        <div class="group relative {{ $loop->iteration % 3 == 1 ? 'h-[650px]' : ($loop->iteration % 3 == 2 ? 'h-[500px]' : 'h-[300px]') }} overflow-hidden rounded-lg">
                        ...
                        <div class="p-2">
                            ...
                            <div class="h-px my-2 bg-slate-300"></div>
    ...
    <section class="mpx-6 md:px-20 py-4">
        ...
        <div data-animate class="md:w-1/2 mt-4">
            ...
            <a href="{{ route('articles') }}" 
                class="button border border-colorOne px-6 py-2 mt-4 inline-flex items-center gap-2 transition-colors rounded-lg">
                View all Blog
