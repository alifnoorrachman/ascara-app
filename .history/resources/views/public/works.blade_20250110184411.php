...
<section class="mx-2 rounded-xl py-12 px-6 sm:px-8 lg:px-20 bg-white">
    <section data-animate class="container mx-auto p-8">
        ...
        <div class=" justify-center sm:flex hidden">
            <div class="flex flex-wrap justify-center gap-4">
                <a href="{{ route('works') }}" 
                   class="px-4 py-2 {{ !request('service') ? 'bg-colorThree text-white' : 'bg-gray-200 border-1 border-colorThree text-colorThree' }} rounded-md transition-colors duration-300">
                    All
                </a>
