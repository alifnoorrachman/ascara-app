        ...
        <div class="sm:hidden mb-10">
            <div class="relative">
                <select 
                    ...
                    class="block will-change-auto px-4 py-2 bg-colorOne text-black rounded-md border border-gray-300 focus:ring-2 focus:ring-black transition-colors duration-300">
