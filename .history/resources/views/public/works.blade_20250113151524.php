...
<section class="mx-2 py-12 px-6 sm:px-8 lg:px-20 bg-colorOne">
    <section data-animate class="container mx-auto flex flex-col lg:flex-row items-center lg:items-start gap-10">
        <!-- Description Section -->
        <div class="lg:w-1/4 text-left">
            <h2 class="text-lg font-semibold text-gray-500">01.</h2>
            <h1 class="text-3xl font-bold leading-tight text-black">VIDEO <br> PRODUCTION</h1>
            <p class="text-gray-600 mt-4">
                We create customized videos on all platforms and activations that differentiate brands and position them to matter in culture.
            </p>
        ...
        <!-- Projects Section -->
        <div class="lg:w-3/4 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            @foreach($works as $work)
                <div class="relative group overflow-hidden rounded-lg">
                    ...
                    <div class="mt-3">
                        <h3 class="text-lg font-semibold text-black">{{ $work->title }}</h3>
                        <p class="text-gray-500 text-sm">Project: {{ $work->service->title }}</p>
                    </div>
                </div>
            @endforeach
        </div>
