...
<section class="mx-2 py-12 px-6 sm:px-8 lg:px-20 bg-colorOne">
    <section data-animate class="container mx-auto flex flex-col lg:flex-row items-start gap-10">
        <!-- Description Section -->
        ...
        <div class="lg:w-3/4 flex flex-col gap-10">
            @foreach($services as $service)
                <div>
                    <h2 class="text-2xl font-bold text-black mb-4">{{ $service->title }}</h2>
                        ...
                        @foreach($service->works as $work)
                            <div class="relative group overflow-hidden rounded-lg">
                                ...
                                <div class="mt-3">
                                    ...
                                    <p class="text-gray-500 text-sm">Project: {{ $service->title }}</p>
                                </div>
                            </div>
                        @endforeach
                    </div>
