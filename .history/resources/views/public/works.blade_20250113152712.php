...
<section class="mx-2 py-12 px-6 sm:px-8 lg:px-20 bg-colorOne">
    <section data-animate class="container mx-auto flex flex-col lg:flex-row items-stretch gap-10">
        
        <!-- Sidebar Section (Left) -->
        <div class="lg:w-1/4 text-left flex flex-col justify-between">
            @foreach($services as $service)
                <div class="mb-10">
        ...
        <!-- Categories and Projects Section (Right) -->
