...
<section class="mx-2 py-12 px-6 sm:px-8 lg:px-20 bg-colorOne">
    <section data-animate class="container mx-auto flex flex-col lg:flex-row items-center gap-10">
        
        <!-- Sidebar Section (Left) -->
        <div class="lg:w-1/4 text-left flex flex-col items-start">
            @foreach($services as $service)
                <div class="mb-10">
        ...
        <div class="lg:w-3/4 flex flex-col items-start gap-10">
            @foreach($services as $service)
                <div>
