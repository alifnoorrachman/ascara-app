            ...
            <div class="flex flex-col lg:flex-row gap-10">
                ...
                <div class="lg:w-1/4 flex-shrink-0">
                    <div>
                        ...
                        <a href="{{ route('service.works.all', ['service' => $service->id]) }}" class="inline-block mt-6 px-6 py-2 border border-colorNetral rounded-md text-colorNetral font-medium hover:bg-black hover:text-white transition-colors">
                            ALL PORTFOLIO
                        </a>
                    </div>
                </div>
