            ...
            <div class="flex flex-col lg:flex-row gap-10">
                ...
                <div class="lg:w-1/4 flex-shrink-0">
                    <div>
                        ...
                        <a href="{{ route('service.works.all', ['service' => $service->id]) }}" class="inline-block mt-6 px-6 py-2 border border-colorNetral rounded-lg text-colorNetral font-medium hover:bg-black hover:text-white transition-colors">
                            ALL PORTFOLIO
                        </a>
                    </div>
                </div>
                                ...
                                <a href="{{ route('works.show', ['id' => $work->id]) }}" class="block">
                                    <div class="relative overflow-hidden">
                                        <img 
                                            ...
                                            class="w-full aspect-[3/4] object-cover transition-transform duration-300 group-hover:scale-105 rounded-md" 
                                            alt="{{ $work->title }}">
                                        <div class="absolute inset-0 bg-black rounded-lg bg-opacity-40 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity">
