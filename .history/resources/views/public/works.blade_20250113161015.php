                                ...
                                <a href="{{ route('works.show', ['id' => $work->id]) }}" class="block">
                                    <div class="relative overflow-hidden">
                                        <img 
                                            ...
                                            alt="{{ $work->title }}">
                                        <div class="absolute inset-0 bg-colorOne/20 rounded-lg bg-opacity-40 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity">
