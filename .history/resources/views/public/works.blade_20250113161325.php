            ...
            <div class="flex flex-col lg:flex-row gap-10">
                ...
                <div class="lg:w-1/4 flex-shrink-0">
                    <div>
                        ...
                        <a href="{{ route('service.works.all', ['service' => $service->id]) }}" class="inline-block mt-6 px-6 py-2 border border-colorNetral rounded-lg text-colorNetral font-medium hover:bg-color bg-colorNetral hover:text-colorOne transition-colors">
                            All Works
                        </a>
                    </div>
                </div>
                    ...
                    <div class="flex gap-6">
                        @foreach($service->works->take(4) as $work)
                            <div class="group relative w-1/4">
                                ...
                                <div class="mt-3">
                                    <p class="text-sm">Project: {{ $work->title }}</p>
                                </div>
                            </div>
                        @endforeach
                    </div>
