...
<section class="mx-2 py-12 px-6 sm:px-8 lg:px-20">
    <section data-animate class="container mx-auto flex flex-col gap-8">
            ...
            <div class="flex flex-col lg:flex-row gap-10">
                ...
                <div class="lg:w-1/4 flex-shrink-0">
                    <div>
                        ...
                        <a href="{{ route('service.works.all', ['service' => $service->id]) }}" class="button inline-block mt-6 px-6 py-2 border rounded-lg  font-medium transition-colors">
                            All Works
                        </a>
                    </div>
                </div>
                                ...
                                <a href="{{ route('works.show', ['id' => $work->id]) }}" class="block">
                                    <div class="relative overflow-hidden">
                                        <img 
                                            ...
                                            alt="{{ $work->title }}">
                                        <div class="absolute inset-0 bg-opacity-40 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity hover:rounded-lg">
                                            <h3 class=" text-lg font-semibold text-center">{{ $work->title }}</h3>
                                        </div>
                                    </div>
                                </a>
                                <div class="mt-2">
                                    <h1 class="text-xl font-bold">{{ $work->brand}}</h1>
