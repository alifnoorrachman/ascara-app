...
@section('content')
<div class="container mx-auto px-4 py-12 text-colorNetral">
    {{-- Breadcrumb --}}
    <div class="mb-8">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
        ...
        <div class="space-y-6">
            ...
            <div class="flex gap-4">
                @if($work->service)
                    <span class="px-4 py-2 bg-colorThree text-colorNetral rounded-full text-sm">
                        {{ $work->service->title }}
                    </span>
                @endif
            </div>
            ...
            <div class="border-t border-gray-200 pt-6 mt-8">
                ...
                <div class="grid grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <p class="font-medium">{{ $work->service->name }}</p>
                    </div>
                    @endif
                    @if($work->service)
                    <div>
                        <span class="text-gray-600">Service</span>
                        <p class="font-medium">{{ $work->service->title }}</p>
                    </div>
                    @endif
                    <div>
            ...
            @foreach($relatedWorks as $relatedWork)
                <div class="bg-white rounded-lg shadow-md overflow-hidden group">
                    @if($relatedWork->image)
                        <div data-animate class="relative overflow-hidden">
                            <img
