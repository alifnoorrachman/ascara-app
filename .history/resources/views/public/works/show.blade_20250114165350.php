        ...
        <div class="space-y-6">
            ...
            <article class="max-w-3xl mx-auto">
                <header class="mb-6 text-start">
                    <h1 class="text-4xl font-medium text-colorNetral">{{ $work->title }}</h1>
                </header>
                <p class="prose prose-lg text-colorNetral">
                    {!! $work->description !!}
                </p>
            </article>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="bg-white rounded-lg shadow-md overflow-hidden group">
                    ...
                    <div class="p-6">
                        ...
                        <p class="text-gray-600 mb-4 prose">{{ Str::limit(html_entity_decode(strip_tags($relatedWork->description)), 100) }}</p>
                        <a 
